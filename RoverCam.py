...
async def main():
    ...
    streamer0 = CameraStreamer(cam_idx=0, port=8765, width=320, height=240, quality=50)
    streamer2 = CameraStreamer(cam_idx=2, port=8766, width=320, height=240, quality=50)
...
if __name__ == "__main__":
    print("Starting multi-camera WebSocket streaming server...")
    print("Camera 0: ws://localhost:8765")
    print("Camera 2: ws://localhost:8766")
